...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("McGregor Core McGregor-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  McGregor-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded McGregor transaction") + "\n" +
              "  McGregor-tx [options] -create [commands]   " + _("Create hex-encoded McGregor transaction") + "\n" +
              "\n";
