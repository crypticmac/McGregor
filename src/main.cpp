...
#if defined(NDEBUG)
# error "McGregor cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "McGregor Signed Message:\n";
...
{
    //MELBO DISABLED SOME CODE UNTIL BLK CHAIN IS BIG ENOUGH
...
void ThreadScriptCheck() {
    RenameThread("McGregor-scriptch");
...
bool ContextualCheckBlockHeader(const CBlockHeader& block, CValidationState& state, CBlockIndex * const pindexPrev)
{
    ...
    // McGregor: Reject block.nVersion=1 blocks (mainnet >= 710000, testnet >= 400000, regtest uses supermajority)
...
bool ContextualCheckBlock(const CBlock& block, CValidationState& state, CBlockIndex * const pindexPrev)
{
    ...
    // McGregor: (mainnet >= 710000, testnet >= 400000, regtest uses supermajority)
